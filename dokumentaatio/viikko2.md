...
_Kysymys: Projektin lopullisessa versiossa tarkoitus on käyttää itse tehtyjä tietorakenteita. Koskeeko tämä vain itse algoritmista ydinosaa, eli saako esim. I/O:ssa käyttää Javan tarjoamia rakenteita (OutputStream, StringBuffer jne)?_
